...
- [ ] (P2) Capture per-attempt actual llm_calls/token consumption so the cost SLO and WS-P2.4 budget enforcement become computable — added 2026-07-23. Plan: docs/superpowers/plans/2026-07-24-cost-actuals-capture.md
