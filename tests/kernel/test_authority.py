...
def test_invalid_normalized_budget_is_recorded_as_unknown() -> None:
    ...
    assert parsed.unknown_fields == frozenset({"budgets.max_attempts"})
    assert parsed.budgets.max_attempts is None
