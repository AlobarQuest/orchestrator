...
nothing else -- not a work unit, not a decomposition, not an approval, and since ADR-0045 not the
act of bringing a stale branch up to date with its base. The orchestrator's own role gate is the
